...
public class ArrayX {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Size = " + x.size + ", Count = "
                + x.count + " Hashcode = " + x.hashCode());

        System.out.println("Array X");
        String display_y = y.toString();
        System.out.println(display_y);
        System.out.println("Size = " + y.size + ", Count = "
                + y.count + " Hashcode = " + y.hashCode());
